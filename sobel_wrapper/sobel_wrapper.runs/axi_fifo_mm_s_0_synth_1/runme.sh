...
HD_PWD='C:/Users/Avishek Maitra/Desktop/Fall2019/sobel_wrapper/sobel_wrapper.runs/axi_fifo_mm_s_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log axi_fifo_mm_s_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source axi_fifo_mm_s_0.tcl
